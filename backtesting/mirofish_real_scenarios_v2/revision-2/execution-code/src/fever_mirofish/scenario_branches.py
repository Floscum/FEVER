...
from .focused_scenarios import FOCUSED_VERSIONS, STRICT_PROMPT_VERSION, candidate_slots, focused_prompt, normalize_focused_fields, validate_focused_grounding
...
"novelty_claim":"...","confidence":0.5}],"warnings":[]}。"""
    ...
    if product:
        ...
        if product_version == PRODUCT_PROMPT_VERSION:
            ...
            system = focused_prompt(strict=product_version == STRICT_PROMPT_VERSION)
...
def build_scenario_branch_set(
    ...
    *,
    ...
    for index, raw in enumerate(raw_branches, start=1):
        ...
        if product and product_version == STRICT_PROMPT_VERSION:
