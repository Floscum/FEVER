...
OUTPUT = ROOT / "artifacts/real-scenarios-v2/revision-3"
...
def prepare():
    if (OUTPUT / "manifest.json").exists():
        ...
        return
    manifest = {"version": 2, "revision": 3, "prepared_at": "2026-09-12", "provider": "DeepInfra", "model": live.MODEL,
                ...
                "design": "v9 failed content review; v10 rejected BYD twice because old simulated rationale contaminated synthesis. v11 sends structured choices without simulated prose and audits unsupported candidate branches individually. All earlier calls remain in the same budget. Repeat v7/v11 on 3 public cases, then 24 anonymous replays and 3 new entity-aware quick simulations. No outcomes or model judging."}
