...
class SimulationGateway:
    ...
    def __init__(
        ...
        *,
        ...
        if self.product_version not in {"v7", "v8", "v9", "v10", "v11"}:
    ...
    def _live_result(self, job_id: str, spec: dict[str, Any]) -> dict[str, Any]:
        ...
        if simulation_result.get("scenario_review", {}).get("withheld_branches"):
            scenario_status = "partial_filtered" if simulation_result.get("scenarios") else "partial_no_paths"
    ...
    def _artifact_payload(
        ...
        *,
        ...
        return {
            ...
            "scenarios": scenarios,
            "scenario_review": simulation_result.get("scenario_review", {}),
            "evidence": spec["facts"],
